// https://school.programmers.co.kr/learn/courses/30/lessons/388353?language=cpp
// 출처: 2025 신규 추가분 (2026-09-20 전수 조사로 로컬 누락 확인)
// ※ 레벨은 외부 블로그 분류 기준이라 공식 등급을 재검증하지 못했다.
...
int main() {
    Tester t("solution");
    // TODO: 문제의 입출력 예로 t.check(...) 를 채울 것
    return t.report();
}
